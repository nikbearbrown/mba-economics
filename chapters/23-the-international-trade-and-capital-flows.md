...
**Exercise 1 — Compute the savings-investment gap.** Tell an LLM: "Country A has GDP of $1 trillion, consumption of $700B, investment of $200B, government purchases of $200B, and exports of $100B. What is the trade balance? What is the savings-investment gap? Show that they're equal (with rounding)." The exercise teaches the identity directly.

**Exercise 2 — Diagnose a country's trade pattern.** Pick a country with a notable trade balance — Germany (surplus), U.S. (deficit), South Korea (surplus), Brazil (variable), China (surplus declining). Ask an LLM to explain what underlies the balance: savings-investment dynamics, trade policy, currency, capital flows.

**Exercise 3 — Argue for and against a trade-deficit reduction policy.** Ask an LLM to argue for a U.S. policy aimed at reducing the trade deficit (some specific tariff, some specific subsidy program). Then to argue against. The exercise tests whether the LLM understands that reducing the deficit requires changing the savings-investment gap, not just trade policy.

**Exercise 4 — Trace a sudden capital outflow.** Tell an LLM about a hypothetical: foreign investors lose confidence in a small open economy and start pulling capital out. Walk through what happens to the trade balance, the currency, the interest rate, GDP, employment. The exercise teaches the open-economy crisis dynamic.
...
```
Chapter 23 of my Policy Brief project. Prior sections in this Claude
Project. Chapter 23 taught: trade accounting (current account = trade
in goods and services + investment income + transfers; capital
account = financial flows; current + capital must balance); the
savings-investment identity (S - I = X - M = current account
balance); why trade deficits aren't always bad (a rapidly growing
country can sustainably run a deficit if the borrowed capital is
funding productive investment); the level of trade vs. the trade
balance (a country can have high trade volumes and balanced trade,
or low volumes and large imbalances); when trade deficits become
problems (when financed by short-term hot money rather than
long-term investment).

Write the brief's "Trade and Capital Flow Effects" section in
300–500 words.

1. **The trade-balance effect.** Does your policy raise or lower
   the trade balance? Tariffs raise the import-competing
   industries' output and reduce imports (small direct effect on
   trade balance, often offset by exchange-rate adjustment).
   Carbon tax can shift competitiveness in carbon-intensive
   tradables. Capital-friendly policies (tax cuts on investment)
   can increase capital inflows and widen the current-account
   deficit.

2. **The savings-investment identity check.** The identity says
   the trade balance = national savings minus national
   investment. If your policy changes either, it changes the
   trade balance. Trace it: does the policy raise or lower
   national savings? National investment? The current-account
   identity tells you the trade balance must move accordingly.

3. **The capital-flow side.** Many policies' international
   effects show up first in capital flows, then in trade. A
   policy that makes domestic assets more attractive draws in
   capital, appreciates the currency, widens the trade deficit.
   The brief should trace the capital-flow channel even for
   policies that aren't directly trade-focused.

End with one sentence on whether the policy's international
effects are large enough to matter, or whether they're swamped
by other factors driving the trade balance and capital flows.
Most domestic policies have small international effects; the
brief should be honest about that.
```

---

**What this produces:** A 300–500 word section on trade and capital-flow effects with the savings-investment identity used as a check.

**How to adapt this prompt:**

- *For your own project:* Tariff students: this is central — tariffs are precisely a trade policy. UBI/safety-net students: the savings-investment identity links to whether the policy is funded by deficits (which import savings from abroad) or taxes (which redistribute domestic savings).
- *For ChatGPT / Gemini:* Works as written.
- *For Claude Code:* Not the primary tool here.
- *For a Claude Project:* Append.

**Connection to previous chapters:** Ch 4 introduced the financial-market basics; Ch 23 puts them in the international frame.
