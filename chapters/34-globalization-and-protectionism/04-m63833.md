...
9485f8e5-30ab-4549-84af-29d053950b0b
...
# The Infant Industry Argument {#fs-idp133941152}
...
[Macroeconomic Policy Around the World](#) for more information on the
...
Do not hand out protectionism and other subsidies to all industries, but
...
where many other industries rely on having the best products available,
because it is not useful to help one industry by imposing high costs on
...
Visit this [website](#) to view a presentation by Pankaj Ghemawat
questioning how integrated the world really is.
::::

# The Anti-Dumping Argument {#fs-idp52547232}
...
# The Environmental Protection Argument {#fs-idm174230336}
...
# The Unsafe Consumer Products Argument {#fs-idm75986896}
...
# The National Interest Argument {#fs-idp52271808}
...
ties between countries. [\#](#) shows the percentages who answered
either "very good" or "somewhat good" for some of countries surveyed.
...
followed by Egypt, Italy, and Argentina.
  ...
  : The Status of Growing Trade Ties between Countries {#Table_34_03}
::::
...
# Key Concepts and Summary {#fs-idp178188336}
...
# Self-Check Questions {#fs-idp112562400}
...
# Review Questions {#fs-idp55187008}
...
# Critical Thinking Questions {#fs-idm81637056}
...
than those that exist in the foreign country where the goods were
produced?
...
each country, in a world without trade, are given in [\#](#) and
[\#](#).
  ...
  : Land of Submarines {#Table_34_05}

What would be the equilibrium price and quantity in each country in a
world without trade? How can you tell?

What would be the equilibrium price and quantity in each country if
trade is allowed to occur? How can you tell?

Sketch two supply and demand diagrams, one for each country, in the
situation before trade.

On those diagrams, show the equilibrium price and the levels of exports
and imports in the world after trade.

If the Land of Submarines imposes an anti-dumping import quota of 30,
explain in general terms whether it will benefit or injure consumers and
producers in each country.

Does your general answer change if the Land of Submarines imposes an
import quota of 70?

# References {#fs-idm59526576}
...
tariffs that would increase the price of these imports to reflect their
cost of production
...
when production locates in countries with the lowest environmental (or
other) standards, putting pressure on all countries to reduce their
