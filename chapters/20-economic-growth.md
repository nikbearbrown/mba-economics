...
**Exercise 1 — Compute compound growth.** Tell an LLM: "An economy grows at 3 percent per year. How long does it take to double in size? Triple? Increase tenfold?" Verify the doubling time using the rule of 70 (roughly 70 / growth rate = doubling time in years). Explore: how does the doubling time change at 2 percent vs. 4 percent vs. 7 percent? The exercise teaches the power of compounding.

**Exercise 2 — Decompose a country's growth.** Pick a country with significant recent growth (China, India, Vietnam, Ethiopia, your pick). Ask an LLM to estimate growth decomposition: how much came from capital deepening, human capital, technology adoption, and TFP? Push for sources and specific numbers.

**Exercise 3 — Predict the next decade.** Ask an LLM to predict whether AI-related productivity gains will significantly boost U.S. labor productivity growth over the next decade. Push for the underlying reasoning: which mechanisms (task automation, knowledge-work productivity, R&D acceleration) and which counterforces (measurement issues, adoption frictions, market power)?

**Exercise 4 — Convergence vs. divergence case study.** Ask an LLM to compare two countries that started at similar GDP per capita 50 years ago and ended up very different (South Korea vs. Philippines, Botswana vs. Zimbabwe, Singapore vs. Jamaica). Push for the institutional, policy, and historical factors that account for the divergence.
...
**What you're building this chapter:** the long-run growth analysis — how the policy affects labor productivity, capital deepening, human capital, and institutions over decades.
...
```
Chapter 20 of my Policy Brief project. Prior sections in this Claude
Project. Chapter 20 taught: two centuries of growth (the modern
era of compound per-capita growth is historically unusual);
labor productivity as the engine; capital deepening (more capital
per worker raises productivity, with diminishing returns); human
capital (education, health, skills) as a complement; institutions
(property rights, rule of law, contract enforcement) as the
foundation; convergence (where it happens — across US states; where
it doesn't — across many countries); the slow-productivity-growth
puzzle of the recent era.

Write the brief's "Long-Run Growth Effects" section in 300–500
words.

1. **The growth-channel identification.** Through which channel
   does your policy affect long-run growth? Investment in physical
   capital? Investment in R&D / human capital? Institutional
   strengthening or weakening? Reallocation of resources from
   lower- to higher-productivity uses (or vice versa)?

2. **The magnitude question.** Most policies have small long-run
   growth effects. A 0.1 percentage-point change in trend growth
   compounds to 10% higher GDP over 100 years — meaningful, but
   often below the noise floor of any honest measurement. Estimate
   your policy's effect (qualitative ranges if quantitative is
   thin) and name the uncertainty.

3. **The institutional dimension.** The hardest claim from the
   chapter is that institutions matter more than physical or human
   capital alone. Does your policy strengthen or weaken
   institutions (property rights, contract enforcement, regulatory
   transparency, accountable governance)? This often matters more
   than the policy's direct effects.

End with one sentence on whether your policy's primary justification
is short-run (current welfare effects) or long-run (growth/
institutional effects). Most policies are presented as short-run
because the long-run effects are speculative; the brief should
name where the policy genuinely depends on long-run claims.
```

---

**What this produces:** A 300–500 word section on the growth channel and its magnitude. The institutional-effect framing is what most policy briefs miss.

**How to adapt this prompt:**

- *For your own project:* Carbon-tax students: long-run effect is forcing the energy transition; the present-value-of-future-climate-damage calculation makes growth analysis central. Antitrust students: long-run innovation effect is the contested claim. Tariff students: long-run effects on industry composition and trade-network depth.
- *For ChatGPT / Gemini:* Works as written.
- *For Claude Code:* Not the primary tool here.
- *For a Claude Project:* Append.

**Connection to previous chapters:** Ch 19's macro framing identified the policy's aggregate scale; Ch 20 extends to the long-run growth horizon.
