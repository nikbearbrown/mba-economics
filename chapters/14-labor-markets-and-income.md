...
**Exercise 1 — Compute marginal revenue product.** Tell an LLM: "A small bakery sells loaves at $5 each. The first hourly baker can produce 10 loaves an hour; the second, 8 more; the third, 5 more; the fourth, 3 more; the fifth, 1 more." Ask the LLM to compute the MRP for each baker. If the wage is $20/hour, how many bakers should the bakery hire? If the wage rises to $30/hour, how many?

**Exercise 2 — Diagnose monopsony.** Pick a labor market you suspect has monopsony features (a small-town hospital, a college town's market for adjunct professors, a company-town factory, an industry dominated by a few large firms). Ask an LLM to assess: how concentrated is the demand side? what evidence would distinguish monopsony from competitive wages? what would a worker observe if monopsony were operating?

**Exercise 3 — Argue both sides of a union.** Ask an LLM to argue both sides: that public-sector unions raise wages and improve services for everyone, and that public-sector unions extract rents at the expense of taxpayers and weaken services. Evaluate which argument has stronger empirical support and identify what specific evidence would settle the disagreement.

**Exercise 4 — Decompose the college premium.** Ask an LLM to decompose the rise in the U.S. college wage premium from 35 percent in 1979 to 70 percent in 2024. What share is due to (a) technology favoring skilled workers, (b) immigration, (c) trade and offshoring, (d) declining unionization, (e) growing market power on the employer side? Push the LLM for specific evidence on each. Notice which forces it can support with research and which it speculates on.
...
**What you're building this chapter:** the deep labor-market analysis — monopsony power, unions, discrimination, immigration — applied to your policy's labor-market effects.
...
```
Chapter 14 of my Policy Brief project. Prior sections in this Claude
Project. Chapter 14 taught: how firms set wages (in competitive
labor markets, the marginal revenue product of labor); monopsony
power (when employers have wage-setting power because labor markets
aren't perfectly competitive — common in concentrated industries
or rural labor markets); unions (countervailing power to monopsony,
or rent extraction depending on the case); bilateral monopoly
(when both sides have power); discrimination (taste-based,
statistical) and the wage gaps it produces; immigration's labor-
market effects (small overall wage effect, larger distributional
effects).

Write the brief's "Labor Market Detail" section in 300–500 words.

1. **The labor markets affected by your policy.** Be specific —
   not "workers" but "low-wage retail workers in metropolitan
   areas," or "engineers at firms with $100M+ revenue," or
   "agricultural workers in California's Central Valley." Different
   labor markets have different elasticities, different concentration,
   different union density.

2. **The monopsony question.** If your policy operates in a labor
   market with monopsony power (concentrated employers, rural
   markets, occupations with limited mobility), the standard
   competitive-market analysis underestimates the policy's
   employment effects in one direction or the other. Minimum-wage
   policy in monopsonistic markets can INCREASE employment;
   antitrust action in a labor market with employer collusion can
   raise wages without reducing jobs. Apply the monopsony lens to
   your policy.

3. **The distributional effect within labor markets.** Most policy
   debates focus on the average effect; the distribution often
   matters more. Who gains, who loses, how concentrated are the
   gains and losses, what does the gain/loss ratio say about
   the policy's normative case?

End with one sentence on the most-likely-to-be-overlooked labor-
market effect of your policy. The brief earns its keep by naming
effects the policy's advocates haven't.
```

---

**What this produces:** A 300–500 word section on labor-market effects with explicit attention to monopsony and distribution. The "most-likely-to-be-overlooked" finding is the discipline.

**How to adapt this prompt:**

- *For your own project:* Minimum-wage students: this is the central chapter — monopsony is the empirical fight. Tariff students: the affected workers are concentrated in import-competing industries; the gainers are dispersed across the economy. Carbon-tax students: workers in fossil-fuel industries face concentrated job loss; renewable workers gain at lower density.
- *For ChatGPT / Gemini:* Works as written.
- *For Claude Code:* Not the primary tool here.
- *For a Claude Project:* Append.

**Connection to previous chapters:** Ch 4 first introduced labor markets; Ch 14 deepens with monopsony and discrimination. Ch 5's elasticity work fed the demand-side; Ch 14 unpacks the supply-side and the market-power layer.
