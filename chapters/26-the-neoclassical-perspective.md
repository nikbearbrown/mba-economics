...
**Exercise 1 — Argue both perspectives.** Tell an LLM the U.S. is in a moderate recession (unemployment 6%, inflation 2%). Ask it to make the Keynesian case for fiscal stimulus and the neoclassical case for monetary discipline. Evaluate both arguments and identify which the LLM weights more heavily.

**Exercise 2 — Apply rational expectations.** Tell an LLM the central bank announces it will tolerate higher inflation to fight unemployment. Walk through what happens when the public believes the announcement (rational expectations) vs. when the public is fooled. The Lucas critique should apply to the first case.

**Exercise 3 — Evaluate a supply-side reform.** Pick a specific supply-side policy proposal (a corporate tax cut, a major infrastructure bill, an education spending package, a deregulation initiative). Ask an LLM to estimate its likely long-run effect on potential GDP and the trade-offs involved.

**Exercise 4 — Diagnose the Volcker disinflation.** Walk an LLM through the 1979–1982 Volcker episode using the neoclassical framework. The aggressive monetary tightening produced recession but broke inflation expectations. The cost (recession) was real; the benefit (long-run price stability) was real and durable.
...
**What you're building this chapter:** the neoclassical reading of your policy as a counter-check on the Keynesian reading from Ch 25. Where the two perspectives agree, the brief's conclusion is robust; where they disagree, the brief should name which assumption is doing the work.
...
```
Chapter 26 of my Policy Brief project. Prior sections in this Claude
Project. Chapter 26 taught: the neoclassical claim that wages and
prices ADJUST flexibly enough that the economy returns to potential
output absent ongoing shocks; rational expectations (agents form
expectations using all available information; systematic policy
effects get anticipated and offset); supply-side policy (focus on
incentives for production rather than demand stimulation); the
modern synthesis (Keynesian in the short run, neoclassical in the
long run; activist policy useful in deep recessions, less useful
near full employment).

Write the brief's "Neoclassical Reading" section in 300–500
words.

1. **The neoclassical case.** What does the neoclassical
   perspective say about your policy? If the policy is supply-
   side oriented (lowering tax wedges, deregulation, expanding
   labor supply), neoclassicism is enthusiastic. If the policy is
   demand-side oriented (transfers, stimulus), neoclassicism is
   skeptical or hostile (will be partially offset by Ricardian
   equivalence, expectations, etc.).

2. **The rational-expectations check.** If your policy is
   anticipated, agents respond before it's enacted. A predicted
   tax increase causes income shifting, asset repricing, behavior
   changes. Has your policy already been priced in? Will it be
   anticipated when enacted?

3. **The Keynes-vs-neoclassical comparison.** Where do the two
   perspectives agree on your policy? Where do they disagree?
   The disagreement is usually about (a) how much slack is in
   the economy, (b) how flexible wages and prices are, (c) how
   forward-looking agents are. Name which of these three is the
   contested empirical question for your policy.

End with one sentence on the modern-synthesis reading — the
Keynesian effects in the short run, neoclassical effects in the
long run. Most defensible briefs end up here.
```

---

**What this produces:** A 300–500 word section that runs the neoclassical framing and compares against Ch 25. The "modern synthesis" framing is the discipline of taking both perspectives seriously.

**How to adapt this prompt:**

- *For your own project:* UBI students: rational expectations predict labor-supply adjustment that Keynesian analysis misses. Tariff students: rational producers shift production before the tariff hits. Carbon-tax students: anticipated long-run pricing forces capital reallocation now.
- *For ChatGPT / Gemini:* Works as written.
- *For Claude Code:* Not the primary tool here.
- *For a Claude Project:* Append.

**Connection to previous chapters:** Ch 25 (Keynesian) + Ch 26 (neoclassical) bracket the macro debate. Both readings matter for the brief.
